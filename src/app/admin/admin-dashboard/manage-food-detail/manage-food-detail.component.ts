...
export class ManageFoodDetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe((params: Params) => {
      ...
      this.foodService.getFoodByIdFromDatabase(this.id);
    })
  ...
  onEditFoodItem() {
    this.foodService.updateFoodItem(this.id, this.editFoodForm.value);
  ...
  onDeleteFoodItem() {
    this.foodService.deleteFoodItem(this.id);
  }
  onAddIngredient() {
